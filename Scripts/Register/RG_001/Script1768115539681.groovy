...
try {
    ...
    TestObject btnRegister = new TestObject('btnRegisterNavbar')

    btnRegister.addProperty('xpath', ConditionType.EQUALS, '//div[@id=\'navbarTogglerDemo02\']/ul/li[7]/a')

    // Alternatif yang lebih stabil (rekomendasi)
    // btnRegister.addProperty("xpath", ConditionType.EQUALS,
    //        "//div[@id='navbarTogglerDemo02']//a[contains(text(),'Register')]")
